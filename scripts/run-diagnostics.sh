...
RESULT="$HOME/Library/Application Support/WeChatCompanion/diagnostics.json"
BEFORE="missing"
...
open -na "$APP_PATH" --args --run-diagnostics
...
echo "Timed out waiting for fresh privacy-safe diagnostics metadata." >&2
exit 1
